<template>
	<div id="num">
		...
		<div class="num-btn">
			<br><br>
			<vbutton type="primary" @abc="sbmites">下一步</vbutton>
			<vbutton type="default" @abc="$router.go(-1)">返回</vbutton>
			<!--<button class="next-btn" @click="sbmites">下一步</button>-->
			<!--<button class="first-btn"  @click="$router.go(-1)">返回</button>-->
		</div>
	</div>
</template>
